...
class _DataServiceDatasetV2(dataset_ops.DatasetSource):
  ...
  def __init__(self,
    ...
    Args:
      ...
      EASL:
        scaling_threshold_up: The threshold (in percentage points) used in the
            AutoScaling policy (generally used for scaling up)
    ...
    self._fast_flow_offloading = ops.convert_to_tensor(
      fast_flow_offloading,
      dtype=dtypes.int64,
      name="fast_flow_offloading")
    ...
    if compat.forward_compatible(2021, 12, 10):
      ...
      variant_tensor = gen_experimental_dataset_ops.data_service_dataset_v3(
          ...
          fast_flow_offloading=self._fast_flow_offloading,
...
class _DataServiceDatasetV1(dataset_ops.DatasetV1Adapter):
  ...
  def __init__(self, dataset_id, processing_mode, address, element_spec,
               ...
               max_request_pipelining_per_worker, fast_flow_offloading,
    ...
    self._wrapped = _DataServiceDatasetV2(
        ...
        fast_flow_offloading=fast_flow_offloading,
        task_refresh_interval_hint_ms=task_refresh_interval_hint_ms,
